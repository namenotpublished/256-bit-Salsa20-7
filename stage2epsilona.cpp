...
command to run:  g++ stage2epsilona.cpp && ./a.out */
...
int IDword[] = {7}, IDbit[] = {13};
int ODword[] = {1}, ODbit[] = {26};
...
int notSignificantBits[] = {12, 27, 28, 29, 30, 31, 46, 66, 67, 86, 87, 88, 96, 97, 98, 99, 100, 101, 102, 103, 108, 109, 110, 111, 119, 120, 121, 122, 123, 124, 125, 126, 127, 165, 166, 167, 168, 169, 170, 171, 172, 173, 174, 175, 176, 177, 178, 186, 187, 194, 217, 218, 219, 220, 221, 222, 223, 224, 225, 226, 227, 231, 232, 233, 254, 255};
